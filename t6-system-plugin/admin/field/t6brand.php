 ...
 * @since  2.5
 */
class JFormFieldT6brand extends FormField
{
    /**
     * The form field type.
     *
    ...
    protected function getInput()
    {
        ...
        return rtrim(LayoutHelper::render($this->layout, $this->getLayoutData(), T6PATH_ADMIN . '/layouts'), PHP_EOL);
    }
