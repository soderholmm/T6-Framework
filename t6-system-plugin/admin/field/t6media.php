...
class JFormFieldT6Media extends MediaField
{
	protected $type = 'T6Media';
	protected function getInput()
	{
		...
		// $mediaId = $this->id;
			...
			<div class="input-group">
				<input type="text" name="'.$this->name.'" id="'.$this->id.'" value="" readonly="readonly" class="form-control field-media-input t6-layout" data-attrname="background_image" >
				<div class="input-group-append">
			...
			$output = (\T6\Helper\J3J4::isJ3()) ? $outputj3 : $outputj4;
			return $output;
	}
}
