 ...
 * @since  2.5
 */
class JFormFieldT6Radio extends FormField
{
	/**
	 * The field type.
	 *
	...
	protected function getInput()
	{
		...
		$html = '';
		$html .= '<input type="checkbox" class="t6-input btn-group radio '.$class.'" data-group="'.$class.'" name="' . $this->name . '" id="'.$this->id.'" value="' . htmlspecialchars($value, ENT_COMPAT, 'UTF-8') . '" '.$checked.'>';
		return $html;
	}
