...
class JFormFieldPalettes extends JFormFieldT6color
{
	/**
	 * The field type.
	 *
	...
	protected function getPalettes() {
		...
		$themeData = (array) json_decode(\T6\Helper\Path::getFileContent('etc/theme/' . $temp_Params->get('typelist-theme') . '.json'), true);
		...
		public function setup(SimpleXMLElement $element, $value, $group = null)
	{
		if(Factory::getApplication()->isClient('administrator')){
			...
			$doc->addScript(T6PATH_ADMIN_URI . '/assets/js/palettes_v2.js');
		}
