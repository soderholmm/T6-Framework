...
$class        = ' class="' . trim('t6-custom-color-spec ' . $class) . ($validate === 'color' ? '' : $inputclass) . '"';
...
Factory::getDocument()->addStyleSheet(T6PATH_ADMIN_URI . '/vendors/spectrum/spectrum.min.css');
Factory::getDocument()->addScript(T6PATH_ADMIN_URI . '/vendors/spectrum/spectrum.min.js');
Factory::getDocument()->addScript(T6PATH_ADMIN_URI . '/assets/js/brand-color.js');
?>
