...
$layoutCls = " t6-layout-palettes";
if($layout == 'theme') $layoutCls = ' t6-theme-palettes';
?>
<div class='pattern-list t6-color-pattern<?php echo $layoutCls;?>'>
	...
	<div class="pattern none" <?php echo RowColumnSettings::getSettings((object)$paletteDef); ?>>
		<div class="pattern-inner">
			<div class="pattern-header">
				<h4 class="pattern-title"><?php echo Text::_('T6_PATTERN_TITLE_NONE');?></h4>
			</div>
			<p><?php echo Text::_('T6_PATTERN_DEFAULT');?></p>
		</div>
	</div>
<?php endif;?>
...
<?php if($layout == 'palettes'): ?>
<div class="t6-layout-pl-preview">
	...
	<?php foreach ($fields as $field) : ?>
		<div class="control-group <?php echo $field['name']; ?>">
			...
			<div class="controls">
				<input 	type="text" name="<?php echo $field['name']; ?>" class="t6-custom-color-spec t6-palette-color-spec t6-pattern <?php echo $field['class']; ?>" data-attrname="<?php echo $field['name']; ?>" value="<?php echo $field['value']; ?>" data-val="" readonly="true" />
			</div><!-- // Controls -->
...
<!-- action-t6-modal-close -->
<div class="t6-palettes-modal" style="display: none;">
	<div class="t6-modal-overlay"></div>
	<div class="t6-modal t6-pattern-row" data-target="#">
		<div class="t6-modal-header">
	    <span class="t6-modal-header-title"><i class="fal fa-cog"></i>Palettes Settings</span>
	    <a href="#" class="action-t6-modal-close"><span class="fal fa-times"></span></a>
	  </div>
		  <div class="t6-modal-inner t6-patterns-inner">
		  	<div class="t6-modal-content">
		  		<div class="row">
						<div class="config_pattern col-7">
							<div class="control-group title">
								<div class="control-label">
									<label><?php echo Text::_('T6_PATTERN_TITLE'); ?></label>
								</div>
								<div class="controls">
									<input 	type="text" name="title" class="t6-pattern title" data-attrname="title" value="" data-val="" placeholder="<?php echo Text::_('T6_PATTERN_TITLE_PLACEHOLDER'); ?>" />
								</div>
								<span class="t6-palette-error error-title-null alert alert-warning" style="display: none"><?php echo Text::_('T6_THEME_PALETTE_TITLE_NULL');?></span>
								<span class="t6-palette-error error-name-exist alert alert-warning" style="display: none"><?php echo Text::_('T6_THEME_PALETTE_NAME_EXIST');?></span>
						...
						<?php foreach ($fields as $field) : ?>
							<div class="control-group <?php echo $field['name']; ?>">
								...
								<div class="controls">
									<input 	type="text" name="<?php echo $field['name']; ?>" class="t6-custom-color-spec t6-pattern <?php echo $field['class']; ?>" data-attrname="<?php echo $field['name']; ?>" value="<?php echo $field['value']; ?>" data-val="" readonly="" />
								</div><!-- // Controls -->

							</div>
						<?php endforeach;?>
						</div>
						<div class="t6-pattern-preview col-5">
							<?php echo Text::_('COLOR_PATTERN_EXAMPLE'); ?>
						</div>
					</div>
		  	</div>
      ...
      <div class="t6-modal-footer">
        <a href="#" class="btn btn-secondary btn-xs t6-patterns-cancel"><span class="fal fa-times"></span> Cancel</a>
        <a href="#" class="btn btn-success btn-xs t6-patterns-apply" data-flag="mega-setting"><span class="fal fa-check"></span> Apply</a>
      </div>
	</div>
</div>

<?php endif;?>
<input id="<?php echo $id?>" class="t6-layout t6-input-color_pattern" name="<?php echo $displayData['input']['name'] ?>" value="<?php echo htmlspecialchars($value);?>" data-attrname="color_pattern" type="hidden" hidden="hidden" />
