...
$filter_class = 't6-font-filter';

?>
<div class="t6-<?php echo $classEvent['events'];?>-modal t6-fonts-manager"  style="display:none">
	<div class="t6-modal-overlay"></div>
	<div class="t6-modal t6-<?php echo $classEvent['events'];?>-setting">
    <div class="modal-header">
      <h5 class="modal-title"><i class="fal fa-font"></i>Fonts Manager</h5>
      <a type="button" class="action-t6-modal-close" data-dismiss="modal" aria-label="Close">
        <span class="fal fa-times" aria-hidden="true"></span>
      </a>
    </div>
    <div class="modal-body t6-<?php echo $classEvent['tabId'];?> t6-font">
			<div class="t6-fonts-filter cleafix">
				<input class="font-filter" name="jform-filter" id="t6-<?php echo $classEvent['filter'];?>" type="text" placeholder="Search..">
			...
			<div class="tab-content" id="managerTabContent">
			  	<div class="tab-pane active" id="jub-<?php echo $classEvent['tabId'];?>" role="tabpanel" aria-labelledby="nav-home-tab">
					<div class="t6-font-filter-message <?php echo $filter_class;?>" style="display:none;"></div>
			  ...
			  <div class="tab-pane" id="custom-<?php echo $classEvent['tabId'];?>" role="tabpanel" aria-labelledby="nav-profile-tab">
					  		...
					  		<?php foreach((array) $customfont->fonts AS $customFont):
								...
								<li class="custom-font custom-<?php echo $classEvent["events"];?>" data-name="<?php echo $customFont->name;?>" data-category="custom" data-styles="<?php if(!empty($dataStyle)) echo $dataStyle;?>">
									<div class="custom-font-container" title="<?php echo $customFont->name;?>">
										...
										<span class="t6-btn btn-action" data-action="fonts.remove" data-tooltip="<?php echo Text::_('T6_FIELD_ADDONS_REMOVE') ?>"><i class="fal fa-trash-alt"></i></span>
									</div>
								</li>
								<?php endforeach;?>
							<?php endif;?>
			  	...
			  	<div class="form-add-custom-font">
				  	<div class="add-more-custom-font">
							<span class="btn-action active" data-action="font.addcss" data-type="css"><?php echo Text::_('T6_THEME_FIELD_ADD_CSS_CUSTOM') ?></span>
							<span class="btn-action" data-action="font.addfont" data-type="font"><?php echo Text::_('T6_THEME_FIELD_ADD_FONT_CUSTOM') ?></span>
						</div>

						<div class="custom-font-form custom-<?php echo $classEvent["events"];?>">
							<div class="control-group custom-font-url" style="display: none;">
								<div class="control-label"><label><?php echo Text::_('T6_THEME_FONT_CUSTOM_FONT_LABEL') ?></label></div>
								...
								<!-- <div class="control-helper"><?php echo Text::_('T6_THEME_FONT_CUSTOM_FONT_DESC') ?></div> -->
							</div>

							<div class="control-group custom-css">
								<div class="control-label"><label><?php echo Text::_('T6_THEME_FONT_CSS_LABEL') ?></label></div>
								<div class="controls"><textarea id="custom-css" class="custom-font-input" name="custom-css" rows="3" data-value=""></textarea></div>
								<!-- <div class="control-helper"><?php echo Text::_('T6_THEME_FONT_CSS_DESC') ?></div> -->
							</div>

							<div class="fonts-actions">
								<span class="t6-btn btn-action btn-primary" data-action="fonts.save" data-type="custom-<?php echo $classEvent["events"];?>"><?php echo Text::_('T6_THEME_FONT_CUSTOM_ADD') ?></span>
							</div>
				  	</div>
			  	</div>
			  </div>
...
<div class="t6-font-weight-popup" style="position:absolute; display: none"></div>
