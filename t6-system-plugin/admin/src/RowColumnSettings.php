...
class RowColumnSettings{
	...
	public static function getTemplateName(){
		// Get the template being edited, not the default template
		$template = Admin::getTemplate();
		if ($template) {
			return $template;
		}
		
		// Fallback to default template if not editing a template
		$db = Factory::getDbo();
	...
	public static function getModuleStyles()
	{
		...
		$moduleStyles = [];
		$moduleStyles = array_merge($moduleStyles, self::_getModuleStyles(T6PATH_BASE . '/html/layouts/chromes'));
		$moduleStyles = array_merge($moduleStyles, self::_getModuleStyles(T6PATH_TPL . '/html/layouts/chromes'));
		$moduleStyles = array_merge($moduleStyles, self::_getModuleStyles(T6PATH_LOCAL . '/html/layouts/chromes'));
	...
	public static function getBlocks () {
		...
		$bpath = T6PATH_THEMES . '/base/html/layouts/t6/block';
		$tpath = JPATH_ROOT . '/templates/'.$templ.'/html/layouts/t6/block';
		$lpath = JPATH_ROOT . '/templates/'.$templ.'/local/html/layouts/t6/block';
	...
	public static function getElements () {
		$templ = self::getTemplateName();
		$bpath = T6PATH_THEMES . '/base/html/layouts/t6/element';
		$tpath = JPATH_ROOT . '/templates/'.$templ.'/html/layouts/t6/element';
		$lpath = JPATH_ROOT . '/templates/'.$templ.'/local/html/layouts/t6/element';
