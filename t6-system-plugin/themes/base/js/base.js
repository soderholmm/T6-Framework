jQuery(document).ready(function($) {
    ...
    $(window).ready(function() {
        if (
            ...
            var sections = document.querySelectorAll(".t6-section");
            var maxIdx = 0;
            var sticky = document.querySelectorAll(".t6-sticky");
            ...
            var anchorEl = $('<a name="top-anchor">').prependTo('.t6-content-inner');
    ...
    $(document).find('.t6-content').on("scroll",function (event) {
        var scroll = $('.t6-content').scrollTop();
...
(function($)
{
    ...
    window.onload = function () {
        ...
        if(document.getElementsByClassName("t6-content").length){
            if (check) {
                var match = localStorage.getItem("page_scroll");
                document.getElementsByClassName("t6-content")[0].scrollTop = match;
            }else{
                document.getElementsByClassName("t6-content")[0].scrollTop = 0;
            }
        }
    }
    //add version to js
