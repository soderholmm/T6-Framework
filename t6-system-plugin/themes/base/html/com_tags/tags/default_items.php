			...
			<fieldset class="com-tags__filters filters d-flex justify-content-between align-items-center">
				<?php if ($this->params->get('filter_field')) : ?>
					<div class="input-group">
						...
						<input type="text" name="filter-search" id="filter-search" value="<?php echo $this->escape($this->state->get('list.filter')); ?>" class="form-control" placeholder="<?php echo Text::_('COM_TAGS_TITLE_FILTER_LABEL'); ?>">
				...
				<?php if (($this->params->get('all_tags_show_tag_description', 1) && !empty($item->description)) || $this->params->get('all_tags_show_tag_hits')) : ?>
					<div class="caption">
						...
						<?php if ($this->params->get('all_tags_show_tag_hits')) : ?>
							<span class="list-hits badge badge-info bg-info">
