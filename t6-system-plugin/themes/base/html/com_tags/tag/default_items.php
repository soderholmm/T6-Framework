...
");
?>
<form action="<?php echo htmlspecialchars(Uri::getInstance()->toString()); ?>" method="post" name="adminForm" id="adminForm" class="com-tags-tag__items form-inline">
			...
			<?php if ($this->params->get('filter_field')) : ?>
				<div class="input-group">
					...
					<span class="input-group-append">
						<button type="submit" name="filter-search-button" title="<?php echo Text::_('JSEARCH_FILTER_SUBMIT'); ?>" class="btn btn-secondary" onclick="document.adminForm.submit();">
