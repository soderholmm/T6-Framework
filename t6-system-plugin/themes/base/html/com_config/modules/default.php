		...
		<div class="col-md-12">
			...
			<div class="row mb-4">
				<div class="col-md-12">
					...
					<?php if ($editorText) : ?>
						<div id="custom" class="mod-content">
			...
			<div class="actions-wrap">
				<button type="button" class="btn btn-success" data-submit-task="modules.apply">
					<span class="icon-save" aria-hidden="true"></span>
					<?php echo Text::_('JAPPLY'); ?>
				</button>
				<button type="button" class="btn btn-success" data-submit-task="modules.save">
					<span class="icon-save" aria-hidden="true"></span>
