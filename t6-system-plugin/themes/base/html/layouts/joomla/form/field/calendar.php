...
if (strtoupper($value) === 'NOW')
{
	...
	$value = Factory::getDate()->format($format);
}
...
if(empty($calendar)) $calendar = Factory::getLanguage()->getCalendar();
if(empty($firstday)) $firstday = Factory::getLanguage()->getFirstDay();
$jweekend = Factory::getLanguage()->getWeekEnd();
$calendarAttrs = [
	'data-inputfield'      => $id,
	'data-button'          => $id . '_btn',
