...
{
	$configViewer = (T6\Helper\J3J4::isJ3()) ? 'controller=config.display.modules' : 'view=modules';
	$editUrl = Uri::base() . 'index.php?option=com_config&'.$configViewer.'&id=' . (int) $mod->id . '&Itemid=' . $itemid . $redirectUri;
	$target  = '_self';
}
