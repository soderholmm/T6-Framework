...
$readmoreText = Text::_('JGLOBAL_READ_MORE');
$readmoreShowTitle = Text::sprintf('JGLOBAL_READ_MORE_TITLE', HTMLHelper::_('string.truncate', $item->title, $params->get('readmore_limit')));
?>
