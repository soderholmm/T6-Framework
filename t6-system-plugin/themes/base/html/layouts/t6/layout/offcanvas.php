...
//$params = json_decode(\T6\Helper\Path::getFileContent('etc/navigation/'.$paramsTpl->get('t6-navigation').'.json'));
...
$offcanvas_title = Text::_('T6_OFF_CANVAS_TITLE');
...
// add css & js
$doc->addStylesheet(T6\Helper\Path::findInTheme('vendors/js-offcanvas/_css/js-offcanvas.css', true));
$doc->addScript(T6\Helper\Path::findInTheme('vendors/js-offcanvas/_js/js-offcanvas.pkgd.js', true));
$doc->addScript(T6\Helper\Path::findInTheme('vendors/bodyscrolllock/bodyScrollLock.min.js', true));
$doc->addScript(T6\Helper\Path::findInTheme('js/offcanvas.js', true));
...
?>
<div class="t6-offcanvas" data-offcanvas-options='<?php echo $options; ?>' id="off-canvas-<?php echo $oc_effect;?>" role="complementary" style="display:none;">
	<div class="t6-off-canvas-header">
	 	<?php if ($hasLink): ?>
	...
	<div class="t6-off-canvas-body menu-item-<?php echo $oc_menu_effect;?>" data-effect="<?php echo $oc_menu_effect;?>">
		<jdoc:include type="modules" name="<?php echo $oc_pos_name ?>" style="<?php echo $oc_pos_style ?>" />
	</div>

	<?php if($doc->countModules('offcanvas-footer')): ?>
		<div class="t6-off-canvas-footer">
