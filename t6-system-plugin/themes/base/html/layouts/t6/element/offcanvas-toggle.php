...
use Joomla\CMS\Factory;
    ...
    // add bodyclass
    if ($show_in_lg) {
        \T6\T6::getInstance()->addBodyClass('oc-desktop');
    }
?>
<?php /* don't remove id="triggerButton" if you override on template */ ?>
<span id="triggerButton" class="btn js-offcanvas-trigger t6-offcanvas-toggle<?php echo $lgsc ?>" data-offcanvas-trigger="off-canvas-<?php echo $oc_effect;?>"><i class="fa fa-bars toggle-bars"></i></span>