<!DOCTYPE html>
<html xmlns="http://www.w3.org/1999/xhtml" class="j{t6post:jversion}" xml:lang="{t6:language}" lang="{t6:language}" dir="{t6:direction}">
...
<body class="{t6post:bodyclass}" data-jver="{t6post:jversion}">
