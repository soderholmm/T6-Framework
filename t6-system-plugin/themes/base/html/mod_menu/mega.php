...
// Add body class
\T6\T6::getInstance()->addBodyClass('nav-breakpoint-' . $navigation_settings->get('option_breakpoint', 'lg'));
...
<button class="navbar-toggler" type="button" data-toggle="collapse" data-target="#<?php echo $navid ?>" aria-controls="<?php echo $navid ?>" aria-expanded="false" aria-label="Toggle navigation" style="display: none;">
	...
	<?php 
		...
		// Add body class
		\T6\T6::getInstance()->addBodyClass('navigation-hide');
	?>
<?php endif ?>
<div id="<?php echo $navid ?>" class="t6-megamenu collapse navbar-collapse<?php  echo $mega_effect ?>"<?php echo $data_duration; ?>>
