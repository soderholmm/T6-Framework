...
class Cache {
	...
	public static function load($key) {
		...
		if ($data) {
			// Note: json_decode removed - data should already be in correct format from cache
			// If JSON decoding is needed, it should be done before storing in cache
			return $data;
		}
