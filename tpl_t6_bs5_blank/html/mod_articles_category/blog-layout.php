...
use T6\Helper\Author as Author;
// load language t6
...
<ul class="blog-list<?php echo $moduleclass_sfx; ?> mod-list row row-cols-1 row-cols-3">
	<?php if ($grouped) : ?>
				...
				<div class="item-meta">
					...
					<span class="item-author" itemprop="author" itemscope itemtype="https://schema.org/Person">
						...
						<?php if(isset($author_info->author_avatar)):?>
							...
							<?php endif; ?>
							<?php echo version_compare(JVERSION,'4.0', 'ge') ? LayoutHelper::render('joomla.html.image',array('src'=>$author_info->author_avatar,'alt'=>$img_alt)) : "<img src=\"".$author_info->author_avatar."\" alt=\"".$img_alt."\"  />";  ?>
							<?php if(!empty($author_info->link)): ?>
							</a>
							<?php endif;?>
							</span>
